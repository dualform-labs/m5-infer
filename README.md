...
| 2 | CTRSP (cross-turn state persist) | — | — | ✅ **12K warm TTFT 11s → 2-3s** |
...
**Result**:
- ✅ 12 K-token tool schema **warm TTFT: 11s → 2–3 s** (5× faster on the second call)
...
**結果**:
- ✅ 12 K token tool schema の **warm TTFT: 11 秒 → 2-3 秒** (2 回目の呼び出しで 5× 高速化)
